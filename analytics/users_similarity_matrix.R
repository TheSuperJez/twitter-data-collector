...
filename.sim <- '../data/outputs/similarity_AMLO_out.csv'
filename.adj <- '../data/outputs/adjacency.csv'
filename.labels <- '../data/AMLO_labeled.csv'

filename.sim <- '../outputs/similarity_LopezObrador_out.csv'
filename.adj <- '../outputs/adjacency-LoperObrador.csv'
filename.labels <- '../badalona_labeled.csv'

filename.sim <- '../outputs/similarity_Mexico_in.csv'
filename.adj <- '../outputs/adjacency-Mexico_out.csv'
...
usernames <- list()
df.users <- data.frame()
for(user in list.files('../data/users/')){
  fname <- paste0("../data/users/", user)
...
save(V, file="adjacency_sorted.RData")
